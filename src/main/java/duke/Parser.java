...
public class Parser {
            ...
            while (!input.equals(KEYWORD_BYE)) {
                ...
                if (input.equals(KEYWORD_LIST)) {
                    ...
                    if (input.contains(KEYWORD_DONE)) {
                        readDoneAndDeleteCommands(input, KEYWORD_DONE, writeFile);
                        ...
                        readDoneAndDeleteCommands(input, KEYWORD_DELETE, writeFile);
    ...
    public static void readTask(String input, String keyword, boolean writeToFile) {
        ...
        try {
            ...
            TaskList.addToTasks(currentTask, writeToFile);
    ...
    public static void readDoneAndDeleteCommands(String command, String keyword, boolean writeFile) {
        ...
        try {
            ...
            if (writeFile) {
                Storage.updateFile(current_task.toString(), keyword);
            }
    ...
    public static Task taskFromFile(String input) throws IllegalEmptyDescriptionException,
            IllegalPrepositionWithoutDate {
